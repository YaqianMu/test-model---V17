...
*20151215        根据EPPA方法，数据，能源平衡表，投入产出表更新2010年排放数据，确定排放系数
*20161201        根据EPPA方法，数据，能源平衡表，投入产出表更新2012年排放数据，确定排放系数
*----------------------------------------------*
...
eet1          energy consumption in 万吨标准煤      等效煤耗
eet2          energy consumption in 万吨标准煤      热当量
...
co2f          co2 emission by fuel in 100 million tons(亿吨)
...
ecoef         energy coefficient (万吨标准煤 per billion yuan)   energy from quantity of value to physical
...
emission0('co2','e',fe,i)=ccoef_p(fe)*int0(fe,i);

...
$prod:y(i)$elec(i)   s:0   a:10   b(a):100    c(a):enesta
        ...
        i:pelec(sub_elec)$ffe(sub_elec)       q:outputelec0(sub_elec)       c:
        i:pelec(sub_elec)$hnb(sub_elec)       q:outputelec0(sub_elec)       b:
...
$prod:yelec(sub_elec)$hnb(sub_elec)  s:esub(sub_elec,"ff") a:0 va(a):esub("elec","kl") l(va):eslm("l")
        o:pelec(sub_elec)$hne(sub_elec)  q:outputelec0(sub_elec)              p:(1-taxelec0(sub_elec))  a:ra  t:taxelec0(sub_elec)
        o:pelec(sub_elec)$wsb(sub_elec)  q:outputelec0(sub_elec)              p:(1-taxelec0(sub_elec))  a:ra  N:t_re(sub_elec)

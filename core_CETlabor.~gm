...
$prod:l_a(lm)       t:1
*        o:pl(i,lm)      q:labor_q0(i,lm)            P:(awage_e(lm)*fwage_s(i,lm))
...
v:qlin(lm,j)           i:pl(j,lm)      prod:y(j)        !labor inputs
v:qlin_ele(lm,sub_elec)      i:pl("elec",lm)      prod:yelec(sub_elec)        !labor inputs
